...
（3）混合型：腺泡萎缩型 MGD 和阻塞型 MGD并存，称为混合型MGD。在阻塞型MGD 初期，睑板腺终末导管阻塞导致腺管压力增加，长期腺管高压力引发腺管扩张，最终继发压迫性或废用性腺泡萎缩，导致混合型MGD。临床最常见的是腺泡萎缩型MGD 与非瘢痕性MGD 并存。当瘢痕性眼睑或结膜病变累及睑板腺和睑缘时，睑酯低排出型MGD的3种类型可共存。  
